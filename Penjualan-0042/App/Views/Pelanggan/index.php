...
<body>
    <div class="container">
        ...
        <a href="index.php?controller=pelanggan&action=create" class="btn btn-medium btn-blue btn-radius">Tambah Data</a>
            ...
            <tbody>
                <?php foreach ($data as $key => $pelanggan): ?>
                    <tr>
                        ...
                        <td>
                            <a href="index.php?controller=pelanggan&action=edit&id=<?= $pelanggan['id_pelanggan'] ?>" class="btn btn-orange btn-radius">Edit</a>
                            <a href="index.php?controller=pelanggan&action=delete&id=<?= $pelanggan['id_pelanggan'] ?>" class="btn btn-red btn-radius" onclick="return confirm('Kamu yakin akan menghapus data ini ?');">Hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
